...
export function HomeGrowthPromotions() {
  ...
  return <section className="home-growth-promotions">
    <div className="home-section-heading"><div><span className="eyebrow">CURATED GROWTH</span><h2>잡아드림이 추천하는 성장 기회</h2><p className="home-section-description">관리자가 고른 고용24 훈련과정과 IT 취업 도서를 확인해 보세요.</p></div></div>
