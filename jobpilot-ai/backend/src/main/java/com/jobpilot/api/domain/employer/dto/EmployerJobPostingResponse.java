...
public record EmployerJobPostingResponse(
        ...
        boolean rollingDeadline, String status, LocalDateTime publishedAt, long viewCount
) {
    public static EmployerJobPostingResponse from(JobPosting posting) {
        return new EmployerJobPostingResponse(
                ...
                posting.getSalary(), posting.getDeadlineAt(), posting.isRollingDeadline(), posting.getStatus(),
