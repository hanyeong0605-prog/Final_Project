...
public class ResumeEntryService {
    ...
    public ResumeEntryResponse create(Long memberId, ResumeEntryRequest request) { return ResumeEntryResponse.from(entries.save(new ResumeEntry(memberId, request.entryType(), request.title().trim(), request.content(), request.displayOrder()))); }
